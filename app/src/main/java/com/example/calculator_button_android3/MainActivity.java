package com.example.calculator_button_android3;
...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnAdd,btnMin,btnMul,btnDiv,btnRem;
    TextView textRes;
    String num1,num2;
    Integer res;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnMin.setBackgroundColor(Color.GREEN);
        btnMul.setBackgroundColor(Color.YELLOW);
        btnDiv.setBackgroundColor(Color.BLUE);
        btnRem.setBackgroundColor(Color.MAGENTA);
